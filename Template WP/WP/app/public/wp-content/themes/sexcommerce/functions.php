...
function odin_enqueue_scripts() {
	...
	if ( defined( 'SCRIPT_DEBUG' ) && SCRIPT_DEBUG ) {
		...
		wp_enqueue_script( 'popper', $template_url . '/assets/js/libs/popper.min.js', array(), null, true );
        wp_enqueue_script( 'bootstrap', $template_url . '/assets/js/libs/bootstrap.js', array(), null, true );
		wp_enqueue_script( 'bootstrap', $template_url . '/assets/js/libs/app.js', array(), null, true );
